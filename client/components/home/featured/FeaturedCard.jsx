...
export default function FeaturedCard({featuredData, navigation}) {
  ...
  return (
    <TouchableOpacity style={styles.featuredCard} onPress={() => navigation.navigate("Details",{_id:featuredData._id})}>
        ...
        <View style={styles.cardContent}>
            ...
            <Text style={{textAlign:"center", fontSize:8, color:'#9b9b9b'}}>Difficulty</Text>
            <View style={{flexDirection:'row',justifyContent:'space-around', padding:10, paddingTop:2}}>
